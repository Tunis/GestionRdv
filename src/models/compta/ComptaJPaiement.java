...
@Entity
@Table(name = "ComptaJPaiement")
public class ComptaJPaiement implements Serializable, Comparable<ComptaJPaiement> {
    ...
    public ComptaJPaiement() {
    }

    public ComptaJPaiement(float espece, Cheque cheque, float cb, Tp tp, float prix, LocalDate date, Rdv rdv) {
        this.espece = espece;
        this.cheque = cheque;
        this.cb = cb;
        this.tp = tp;
    ...
    public boolean equals(Object o) {
        ...
        ComptaJPaiement paiement = (ComptaJPaiement) o;
    ...
    @Override
    public int compareTo(ComptaJPaiement o) {
